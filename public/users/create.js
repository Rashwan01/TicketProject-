...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../helpers/Form'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      form: new !(function webpackMissingModule() { var e = new Error("Cannot find module '../helpers/Form'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
        name: "",
        email: "",
        username: "",
        password: ""
            ...
            _c("div", { staticClass: "form-group row" }, [
              ...
              _c("div", { staticClass: "col-lg-10" }, [
                _c("select", { staticClass: "form-control" }, [
                  _c("option", { attrs: { value: "opt1" } }, [
                    _vm._v(_vm._s(_vm.$t("inputs.choose")))
                  ]),
                  _vm._v(" "),
                  _c("option", { attrs: { value: "opt2" } }, [
                    _vm._v("Option 2")
                  ])
                ])
              ])
